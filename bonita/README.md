...
-	Launch the new container pointing towards the copy of the database.
	...
	```console
	$ docker run --name=bonita --link mydbpostgres:postgres -e "DB_NAME=newbonitadb" -e "DB_USER=newbonitauser" -e "DB_PASS=newbonitapass" -d -p 8081:8080 s390x/bonita:2022.2-u0
	```
